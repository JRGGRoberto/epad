...
<h4>Quadro de professores atual da UNESPAR</h4>
<?= $tbl_contrads ?>
<hr>

<h4>Distribuição de RT no campus <?=  $user['lota_nome']  ?></h4>
<?= $tbl_rt ?>
<hr>

<h4>Matriz(es) do curso <?=  $user['lota_nome']  ?>/<?=  $user['ce_cod']  ?> <?=  $user['co_nome']  ?></h4>
<?= $tbl_matriz ?>
<hr>

<h4>Matriz(es)/Disciplinas do curso <?=  $user['lota_nome']  ?>/<?=  $user['ce_cod']  ?> <?=  $user['co_nome']  ?></h4>
<?= $tbl_disc ?>
<hr>

<h4>Quadro de professores do colegiado <?=  $user['lota_nome']  ?>/<?=  $user['ce_cod']  ?> <?=  $user['co_nome']  ?></h4>
<?= $tbl_prof ?>
<hr>
