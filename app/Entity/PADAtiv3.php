...
class PADAtiv3 {
  ...
  public static function get($where = null, $order = null, $limit = null){
    return (new Database('pad3'))->select($where,$order,$limit)
                                  ->fetchAll(PDO::FETCH_CLASS,self::class);
  } 

  public static function getById($id){
    $where = ' id = "'.$id.'" ';
    return (new Database('pad3'))->select($where)
                                     ->fetchObject(self::class);
  }


  public static function getQntd($where = null){
    return (new Database('pad3'))->select($where, null, null, 'COUNT(*) as qtd')
                                  ->fetchObject()
                                  ->qtd;
  }
  ...
  public function excluir(){
    return (new Database('pad3'))->delete('id = "'.$this->id .'"');
  }
