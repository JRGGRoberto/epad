...
<div class="container p-3 my-3 bg-white text-dark" style="padding : 25px">
  ...
  <table id="tabelaMatD" name="tabelaMatD" class="table table-bordered table-sm table-hover">
        <thead class="thead-light" style="background: white; position: sticky; top: 0; z-index: 10;">
          <tr>
            <th colspan="4"><input class="form-control" id="impBuscarDis" type="text" placeholder="Localizare"></th>
          </tr>

         <tr>
            <th class="align-top" width="300px;">Nome</th>
            <th class="align-top" width="220px;">Assunto</th>
            <th class="align-top" width="100px;">Tipo</th>
            <th class="align-top">Mensagem</th>
        </tr>
    </thead>
    <tbody style="font-size: 14px; color: #485460; ">
