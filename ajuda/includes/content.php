...
<div class="container mt-3">
  ...
  <h1 class="mt-3">
    ...
    <span style="color: #007F3D; text-shadow: 0 0 2px rgba(0,0,0,0.6);;">PAD</span> - Ajuda</h1>
...
<div class="container p-3 my-3 bg-white text-dark" style="padding : 25px">
  ...
  ">
  <h3>Introdução</h3>
  <p>Acompanhando os avanços tecnológicos para garantir a eficiência, transparência e precisão das informações. Apresentamos o ePAD, um sistema intuitivo para o 
