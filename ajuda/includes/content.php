  ...
  <div class="card">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <div id="disciplinas" class="collapse" data-parent="#accordion">
          <div class="col">
            <p>Depois de acessar a matriz, o DRA, Diretoria de Registro Acadêmico, também é responsável por inserir as disciplinas contindas nela.</p>
            <p></p>
      ...
      <div id="menu_meupad" class="collapse" data-parent="#accordion">
        <div class="card-body row">
          <div class="col">
            ...
            <ul>
              <li>1. Dados do Docente</li><sup> Dados preenchidos automáticamente, importados pela PROGESP.</sup>
            ...
            <p><img src="../imgs/prnpad.png" alt="PAD"> abre uma aba apropriada para imprimir-lo.</p>
            ...
            <p>Os calculos são realizados automaticamente.</p>
      ...
      <div id="menu_orientar" class="collapse" data-parent="#accordion">
        <div class="card-body row">
          <div class="col">
            ...
            <p>Quando o coodernador de curso o selecionou para alguma função de coordenação este menu aparece para ti</p>
        ...
        <div class="card-body row">
          <div class="col">
            ...
            <ul>
              ...
              <li>Informações <sub>Informações gerais referente aos dados do PAD no colegiado</sub></li>
            </ul>
    ...
    <div class="card">
      <div class="card-header">
        <a class="card-link" data-toggle="collapse" href="#orient_esttbr">
          Orientação a Estágio ou Trabalhos Academicos
        </a>
      </div>
    ...
    <div class="card">
      ...
      <div id="coord_aulas" class="collapse" data-parent="#accordion">
        <div class="card-body row">
          <div class="col">
            <p>Quando o curso possui mais de uma matriz, é apresentado para selecionar a matriz, exemplo matriz matutina, diurna, uma que está a atender um regulamento antigo e outra um novo.</p>
            <img src="../imgs/selmatriz.png" alt="Selecinar matriz" >
